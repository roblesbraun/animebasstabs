    ...
    <body>
        ...
        <nav class="bg-gradient-to-br from-gray-50 to-gray-300 shadow-md sticky top-0 z-10">
                ...
                <div class="flex justify-between">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="../index.html" class="flex items-center py-2 px-2 text-gray-200">
                            <img class="rounded-full mx-1" src="https://yt3.ggpht.com/uwbtBfh79HEuFa-Ud8nyY80_4ddgMQ-9jeiy90Z4A7uMZp_L_CHbh9m-oAic66TePLGrflwrsA=s176-c-k-c0x00ffffff-no-rj-mo" alt="" width="50">
                    ...
                    <div class="hidden md:flex items-center space-x-1">
                        ...
                        <a href="./tabs.html" class="flex items-center py-2 px-3 text-black rounded hover:bg-gray-300 hover:text-black transition duration-500">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="mobile-menu hidden md:hidden p-1">
                ...
                <a href="./tabs.html" class="flex justify-center items-center py-2 px-3 text-black rounded hover:bg-gray-300 hover:text-black transition duration-500">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M18 3a1 1 0 00-1.196-.98l-10 2A1 1 0 006 5v9.114A4.369 4.369 0 005 14c-1.657 0-3 .895-3 2s1.343 2 3 2 3-.895 3-2V7.82l8-1.6v5.894A4.37 4.37 0 0015 12c-1.657 0-3 .895-3 2s1.343 2 3 2 3-.895 3-2V3z" />
                    </svg>
                    <span>Tabs</span>
        ...
        for($i=65; $i<=90; $i++) {  
            $letter = chr($i);
            $contador = 0;
            $sql = "select count(*) from artistas where Nombre like '".$letter."%'";
            ...
            if ($contador != 0) {
                ...
                <div class="container flex flex-col space-y-4 mx-auto p-7">
                        <h1 class="text-2xl"><?php echo $letter; ?></h1>
                        <hr class="my-3">
                <?php
                while ($row = mysqli_fetch_row($result)) {
                    ?>
        ...
        <footer class="text-gray-600 body-font">
            <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                    <img class="rounded-full mx-1" src="https://yt3.ggpht.com/uwbtBfh79HEuFa-Ud8nyY80_4ddgMQ-9jeiy90Z4A7uMZp_L_CHbh9m-oAic66TePLGrflwrsA=s176-c-k-c0x00ffffff-no-rj-mo" alt="" width="40">
